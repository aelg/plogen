...
void run_straight(uint8_t difference){
	...
	if(pdreg_value < 0){
		OCR1A =	0x0080;//sets the length of pulses, right side - pin7
		OCR1B =	0x0080+pdreg_value;//sets the length of pulses, left side - pin8

	
	}
	else{
		OCR1A =	0x0080-pdreg_value;//sets the length of pulses, right side - pin7
		OCR1B =	0x0080;//sets the length of pulses, left side - pin8
